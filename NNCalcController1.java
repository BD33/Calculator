...
public final class NNCalcController1 implements NNCalcController {
    ...
    private static void updateViewToMatchModel(NNCalcModel model,
        ...
        if (bottom.compareTo(INT_LIMIT) <= 0) {
            //checks to make sure the number is within ranfe
    ...
    public void processEnterEvent() {
        NaturalNumber top = this.model.top();
        NaturalNumber bottom = this.model.bottom();
        //copies bottom and sets it to top
        top.copyFrom(bottom);
    ...
    public void processSubtractEvent() {
        ...
        NaturalNumber top = this.model.top();
        NaturalNumber bottom = this.model.bottom();
        //subtracts the top from the bottom

        //if the user ask to subract zero set the bottom to the top
        if (bottom.isZero()) {
    ...
    public void processMultiplyEvent() {
        NaturalNumber top = this.model.top();
        NaturalNumber bottom = this.model.bottom();
        //multiplys the bottom  by the top
        bottom.multiply(top);
    ...
    public void processPowerEvent() {
        NaturalNumber top = this.model.top();
        NaturalNumber bottom = this.model.bottom();
        //puts the bottom number to the power of the top number
    ...
    public void processRootEvent() {
        ...
        NaturalNumber top = this.model.top();
        NaturalNumber bottom = this.model.bottom();
        // if the top number is zero then it sets both top and bottom to  zero
        if (top.isZero()) {
            bottom.clear();
        } else {
